...
import '../../../ppm/view/bloc/asset/asset_bloc.dart';
import '../bloc/request_view_bloc.dart';
import '../bloc/request_view_event.dart';
import '../bloc/request_view_state.dart';
...
class _PPMDetailsStateState extends State<PPMDetailsState> {
  ...
  _pickDocument() async {
    ...
    if (result != null) {
      ...
      requestViewBloc
          .add(uploadFileInProgressEvent(selectedDocumentFile, file.name));
    } else {
                        ...
                        if (state is RequestViewLoadedState) {
                          if (state.requestViewModel.status!) {
                            setState(() {
                              ...
                              List<Asset> assets = state.requestViewModel.assets;
                            ...
                            priorityController.text = priorityName;
                              addnLocController.text = additionalSpace;
                    ...
                    BlocListener<AssetScanBloc, AssetScanState>(
                      listener: (context, state) async {
                        if (state is AssetScanLoadedState) {
                          ...
                          //
                          if(state.asset_response.message == "Success") {
                           // Utils.showInSnackBar(context, state.asset_response.message, ToastType.Success);
                            ...
                            Utils.showInSnackBar(
                                context, state.asset_response.message, ToastType.Warning);
                          }
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: isSubmitting
                          ...
                          String assetID = assetid_List.join(',');
                          ...
                          requestViewBloc.add(RequestViewSubmitEvent(
                            ...
                            additionalSpace,
                            uploadedFiles,
                            estimatedAmtController.text.toString(),
                            assetID
                          ));
                        },
                        style: ElevatedButton.styleFrom(
