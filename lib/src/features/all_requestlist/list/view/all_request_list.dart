...
import '../../../request/list/bloc/request_list_bloc.dart';
import '../../../request/list/bloc/request_list_event.dart';
import '../../../request/list/bloc/request_list_state.dart';
import '../../../request/list/model/request_list_model.dart';

class AllRequestList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: AllRequestListWidgetContent(),
    );
  }
}

class AllRequestListWidgetContent extends StatefulWidget {
  @override
  _AllRequestListWidgetContentState createState() =>
      _AllRequestListWidgetContentState();
}
...
class _AllRequestListWidgetContentState
  ...
  Future<void> checkLocationPermission() async {
    ...
    if (status == my_location.PermissionStatus.granted) {
                  ...
                  if (state is LocationInitialState) {
                    ...
                    if (state.locationresponse.status) {
                      ...
                      Navigator.pushNamed(
                        ...
                        arguments: {'RequestID': requestedID},
                      );
                    ...
                    child: InkWell(
                        onTap: () async {
                          ...
                          if (result != null && result is String) {
                            ...
                            requestListBloc.add(RequestListLoadEvent(
                                selectedID, type, selectedRequestId,0));
                          }
                        },
